...
export const tools: ToolDefinition[] = [
  {
    ...
    category: "security",
    icon: "lock",
    metaTitle: "JWT Decoder & Token Inspector — Header & Claims",
    metaDescription: "Free online JWT decoder. Decode JSON Web Tokens and inspect header, payload, and signature instantly. 100% client-side, zero data sent to any server.",
  ...
  },
  {
    ...
    category: "security",
    icon: "fingerprint",
    metaTitle: "Online Hash Generator — MD5, SHA-1, SHA-256, SHA-512",
    metaDescription: "Free online cryptographic hash generator. Compute MD5, SHA-1, SHA-256, and SHA-512 hashes instantly in your browser with zero data upload.",
  ...
  },
  {
    ...
    category: "formatters",
    icon: "data_object",
    metaTitle: "JSON Formatter & Validator — Beautify & Minify",
    metaDescription: "Free online JSON formatter, validator, and beautifier. Pretty-print, minify, and fix JSON with syntax highlighting and instant error detection.",
  ...
  },
  {
    ...
    category: "encoders",
    icon: "lock",
    metaTitle: "Base64 Encoder & Decoder — Text & File Converter",
    metaDescription: "Free online Base64 encoder and decoder. Convert text, images, and files to and from Base64 encoding. 100% client-side and completely private.",
  ...
  },
  {
    ...
    metaDescription: "Free online URL encoder and decoder. Encode and decode query parameters, URIs, and special characters safely in your browser.",
  ...
  },
  {
    ...
    category: "encoders",
    icon: "code",
    metaTitle: "HTML Entities Encoder & Decoder — Escape Characters",
    metaDescription: "Free online HTML entities encoder and decoder. Convert special characters to HTML entities and escape code to prevent XSS vulnerabilities.",
  ...
  },
  {
    ...
    category: "generators",
    icon: "vpn_key",
    metaTitle: "Strong Random Password Generator — Free & Secure",
    metaDescription: "Free online strong random password generator. Create secure passwords with custom length, symbols, and numbers using Web Crypto API. 100% private.",
  ...
  },
  {
    ...
    category: "generators",
    icon: "tag",
    metaTitle: "UUID Generator — Bulk Random UUID v4 & GUID Online",
    metaDescription: "Free online UUID generator. Generate bulk random RFC 4122 UUID v4 identifiers and GUIDs instantly in your browser with zero server requests.",
  ...
  },
  {
    ...
    metaDescription: "Free online Lorem Ipsum generator. Create placeholder dummy text by paragraphs, sentences, or words for your designs, mockups, and wireframes.",
  ...
  },
  {
    ...
    category: "converters",
    icon: "swap_horiz",
    metaTitle: "YAML to JSON & JSON to YAML Converter Online",
    metaDescription: "Free online YAML to JSON and JSON to YAML converter. Convert between formats with syntax highlighting and instant validation. 100% client-side.",
  ...
  },
  {
    ...
    category: "converters",
    icon: "palette",
    metaTitle: "Color Converter — HEX, RGB, HSL & HSV Online Picker",
    metaDescription: "Free online color converter and picker. Convert between HEX, RGB, HSL, and HSV color formats with live preview and CSS color codes.",
  ...
  },
  {
    ...
    category: "text",
    icon: "text_fields",
    metaTitle: "Text Case Converter — camelCase, snake_case, UPPER",
    metaDescription: "Free online text case converter. Convert text between camelCase, PascalCase, snake_case, kebab-case, UPPERCASE, and lowercase instantly.",
  ...
  },
  {
    ...
    category: "text",
    icon: "description",
    metaTitle: "Live Markdown Editor & Previewer Online with HTML",
  ...
  },
  {
    ...
    category: "images",
    icon: "image",
    metaTitle: "Image Converter — WebP, PNG, JPG In-Browser",
  ...
  },
  {
    ...
    category: "formatters",
    icon: "storage",
    metaTitle: "SQL Formatter & Beautifier — Clean SQL Queries",
  ...
  },
  {
    ...
    category: "text",
    icon: "manage_search",
    metaTitle: "Regex Tester & Debugger — JavaScript Regex",
    metaDescription: "Free online regex tester. Test regular expressions in real-time with match highlighting, group capture, and replace functionality. 100% client-side.",
  ...
  },
  {
    ...
    category: "formatters",
    icon: "data_array",
    metaTitle: "XML Formatter & Validator — Beautify XML Online",
  ...
  },
  {
    ...
    category: "converters",
    icon: "table_chart",
    metaTitle: "JSON to CSV Converter — Export Tables Online",
  ...
  },
  {
    ...
    category: "converters",
    icon: "straighten",
    metaTitle: "PX to REM Converter — CSS Units Calculator",
  ...
  },
  {
    ...
    category: "web",
    icon: "deployed_code",
    metaTitle: "Kubernetes YAML Validator — Check K8s Manifests",
  ...
  },
  {
    ...
    category: "web",
    icon: "deployed_code",
    metaTitle: "Docker Compose Validator — Verify YAML Syntax",
    metaDescription: "Free online Docker Compose validator. Check docker-compose.yml files for correct YAML syntax, service structure, image references, port mappings, and volume configurations. 100% client-side.",
  ...
  },
  {
    ...
    category: "web",
    icon: "deployed_code",
    metaTitle: "GitHub Actions Validator — Check Workflow YAML",
  ...
  },
  {
    ...
    category: "security",
    icon: "timer",
    metaTitle: "JWT Expiration Checker — Verify Token Expiry",
  ...
  },
  {
    ...
    category: "generators",
    icon: "tag",
    metaTitle: "UUID v7 Generator — Time-Ordered Unique IDs",
  ...
  },
  {
    ...
    category: "text",
    icon: "numbers",
    metaTitle: "Word & Character Counter — Reading Time Calculator",
  ...
  },
  {
    ...
    metaTitle: "Remove Duplicate Lines — Text Deduplicator Online",
  ...
  },
  {
    ...
    category: "generators",
    icon: "qr_code",
    metaTitle: "Wi-Fi QR Code Generator — Connect Without Passwords",
  ...
  },
  {
    ...
    category: "generators",
    icon: "vpn_key",
    metaTitle: "Wi-Fi Password Generator — High-Entropy WPA2/WPA3",
  ...
  },
  {
    ...
    category: "generators",
    icon: "qr_code",
    metaTitle: "QR Code Generator — Free Custom QR Codes Online",
